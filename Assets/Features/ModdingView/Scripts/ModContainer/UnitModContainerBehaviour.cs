...
namespace Features.Loot.Scripts.ModView
{
    public class UnitModContainerBehaviour : MonoBehaviour, IDropHandler, IModContainer
    {
        ...
        public void ApplyOnUnitViewInstantiated(UnitDisplayBehaviour unitDisplayBehaviour)
        {
            ...
            ContainedModBehaviour.ContainedMod.ApplyOnUnitViewInstantiated(unitDisplayBehaviour);
        }
        ...
        public void OnDrop(PointerEventData eventData)
        {
            ...
            ModSwapHelper.Perform(movingMod, ContainsMod ? ContainedModBehaviour : null,
