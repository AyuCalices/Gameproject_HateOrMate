...
namespace Features.Unit.Scripts.Class
{
    public class TroopBattleClass : BattleClass
    {
        ...
        {
            _attackSpeedDeltaTime = ownerNetworkingStatsBehaviour.GetFinalStat(StatType.Speed);
        }

        protected override void InternalInitializeBattleActions()
        {
            _attackSpeedDeltaTime = ownerNetworkingStatsBehaviour.GetFinalStat(StatType.Speed);
            ownerUnitBattleView.SetStaminaSlider(_attackSpeedDeltaTime, ownerNetworkingStatsBehaviour.GetFinalStat(StatType.Speed));
        }
        ...
        {
            SendAttack(ownerBattleBehaviour.GetTarget.Key, ownerNetworkingStatsBehaviour.GetFinalStat(StatType.Damage));
        }
