...
namespace Features.Unit.Scripts.Behaviours.Battle
{
    ...
    [RequireComponent(typeof(UnitStatsBehaviour), typeof(UnitBattleView))]
    public class UnitBattleBehaviour : MonoBehaviour
    {
        [Header("References")]
        ...
        {
            Debug.Log(UnitServiceProvider.GetService<UnitStatsBehaviour>().GetFinalStat(StatType.Health));
        }
    }
}